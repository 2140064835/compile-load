...
import com.clay.v2.ApplicationUtil;
import com.clay.v2.TestService;
...
public class DemoController implements ApplicationContextAware {
    ...
    private static String javaSrc = "package com.clay.v2;" +
            "public class TestClass extends com.clay.v2.TestService{" +
